...
vicious.register(memwidget, vicious.widgets.mem, '<span color="#00EE00"> $1%</span>', 1)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Shift",          }, "Print",                 function () awful.util.spawn("import -quality 100  sora screenshot.jpg") end),
